...
python experiment.py --wandb_key ec26ff6ba9b98d017cdb3165454ce21496c12c35  --test_interval 4000 --train_frames 100000   --delta 0.01 0.1 0.5 --seed 1 2 3 --robust_batch_size 512  --grad_batch_size 256  --learning_rate 0.0005  --radial_basis_dist 2  --radial_basis_var 3  --noise_var 0.01  --gamma 0.99  --bin_size 512  --fineness 2  --non_linear  --robust_agent  --train_identifier robust_new_rb
