...
def get_and_plot_csv_data(delta):
...
def get_and_plot_q_vals(delta, same_plot=True, vertical_lines=False):
...
load_and_test_agent(delta=0.1, test_games=10, render_games=10)
